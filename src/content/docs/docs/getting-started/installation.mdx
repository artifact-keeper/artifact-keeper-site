...
| Service | ghcr.io (default) | Docker Hub | Description |
|---------|-------------------|------------|-------------|
| **Backend** | `ghcr.io/artifact-keeper/artifact-keeper-backend` | `artifactkeeper/backend` | Rust API server (45+ format handlers) |
